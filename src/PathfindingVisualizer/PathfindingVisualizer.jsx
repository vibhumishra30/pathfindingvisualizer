...
export default class PathfindingVisualizer extends Component {
  ...
  visualizeDijkstra() {
    this.setState({ topMessage: "Finding Shortest Path" });
    ...
    let textBox = (
      <div className="textBox">
        <div className="weightContainer">
          <label htmlFor="quantity">Value of Weight: </label>
        ...
        <div className="startPointContainer">
          <label htmlFor="point">Start Node Index :</label>
          <input
            type="number"
            name="point"
            id="start_row"
        ...
        <div className="endPointContainer">
          <label htmlFor="point">End Node Index :</label>
          <input
            type="number"
            name="point"
            id="end_row"
      ...
      <div className="pathfindingVisualizer">
        <div className="container">
          <div className="heading">
            <h2 onClick={showPopUp}>Path Finder</h2>
            <h2>{topMessage}</h2>
          </div>
