...
import start from '../Node/images/start.png'; 
  ...
  render() { 
    return (
      <div className="PopUpTextBox">
        <header>
          <p>Welcome to Path-Finder!</p>
          <h3 onClick={skipPopUp}>x</h3>
        </header>

        <div className="PopUpIntroductionText">
          <h3>Here are the symbols for various entities</h3>
        ...
        <div className="skipBox">
          <small>*Wanna go through it again? Just Click on <span>[Path Finder]</span></small>
